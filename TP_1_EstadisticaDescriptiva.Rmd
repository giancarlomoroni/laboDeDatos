...
Vamos a seleccionar solamente aquellas propiedades en dolares y construimos la nueva variable fondo. <br / >
### Parte 1
```{r}
...
coplot(df$price ~ df$surface_total | propiedades,xlim = c(0,5000),rows = 1,ylim = c(0,0.6e7), xlab = "Superficie total", ylab = "Precio", pch = 20)
```
<br /> 
